    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          Patterns from the last 7 days help us understand your mental wellness journey.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          These signals help detect patterns without relying solely on self-reported data.
        </p>
      </motion.div>
